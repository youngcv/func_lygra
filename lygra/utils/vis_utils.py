...
def get_vector_field(vec_origin, vec_direction, color=None):
...
def get_vector_fields(vec_origins, vec_directions, colors=None):
    colors = colors or []
    vector_fields = []
...
def visualize_vector_field(vec_origin, vec_direction, color=None):
    color = color or [1, 0, 0]
    vector_fields = []
...
def visualize_vector_fields(vec_origins, vec_directions, colors=None):
    colors = colors or []
    vector_fields = []
    for i, (vec_origin, vec_direction) in enumerate(zip(vec_origins, vec_directions)):
        if i < len(colors):
